@testset "limiters" begin 
	...
	delta = 1.0
	@test isapprox(DiscretisedFluidQueues.linear(linear_coeffs2,V2...,delta),
		(linear_coeffs2,2.0/delta^2)
	delta = 0.25
	@test isapprox(DiscretisedFluidQueues.linear(linear_coeffs2,V2...,delta),
		(linear_coeffs2,2.0/delta^2)
	...
	delta = 1.0
	@test isapprox(DiscretisedFluidQueues.linear(linear_coeffs3,V3...,delta),
		(linear_coeffs3,0.0)
	delta = 0.25
	@test isapprox(DiscretisedFluidQueues.linear(linear_coeffs3,V3...,delta),
		(linear_coeffs3,0.0)
	...
	linear_coeffs3 = [1/6; 2/3; 1/6]
	delta = 1.0
	@test isapprox(DiscretisedFluidQueues.linear(quadratic_coeffs3,V3...,delta),
		(linear_coeffs3,0.0)
	delta = 0.25
	@test isapprox(DiscretisedFluidQueues.linear(quadratic_coeffs3,V3...,delta),
		(linear_coeffs3,0.0)
